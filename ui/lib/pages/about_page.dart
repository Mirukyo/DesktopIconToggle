...
class _AboutPageState
  ...
  static const String repositoryOwner =
      'Mirukyo';

  static const String repositoryName =
      'DesktopIconToggle';
  ...
  static final Uri websiteUri = Uri.parse(
    'https://soyoo.top/',
  );
...
class _LinkCard
  ...
  @override
  State<_LinkCard> createState() =>
      _LinkCardState();
}

class _LinkCardState
    extends State<_LinkCard> {
  bool _hovered = false;
